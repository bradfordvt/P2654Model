#!/usr/bin/env python
"""
    Description information for all instances of ScanRegister Assembly.
...
# create logger
module_logger = logging.getLogger('P2654Model.description.ScanRegisterDescription')


@logged
@traced
class ScanRegisterDescription(AssemblyDescription):
